...
# Expanded Symptom-Disease mapping with more options
symptom_disease_map = {
...
# Disclaimer
st.markdown(
    "<div style='position: fixed; bottom: 20px; width: 100%; text-align: center; color: #721c24; font-size: 16px;'>"
    "<strong>Disclaimer:</strong> This tool provides potential disease suggestions based on symptoms. It is not a substitute for professional medical diagnosis or treatment. Always consult a healthcare provider for medical advice.</div>",
    unsafe_allow_html=True
)
